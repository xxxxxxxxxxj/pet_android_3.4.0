...
public class NoteActivity extends SuperActivity implements OnClickListener{
	...
	private EditText textview_cname,textview_tel;
	...
	private void findView() {
		...
		textview_cname = (EditText) findViewById(R.id.textview_cname);
		textview_tel = (EditText) findViewById(R.id.textview_tel);
	...
	private void setView() {
		...
		if (previous==Global.ORDERDDETAIL_NEW_TO_CHOOSE_REMARK) {
			tvTitle.setText("联系人及订单备注");
			...
			String cphone = getIntent().getStringExtra("cphone");
			textview_cname.setText(cname);
			textview_tel.setText(cphone);
		}
...
//			finishWithAnimation();
			...
			data.putExtra("cname", textview_cname.getText().toString());
			data.putExtra("cphone", textview_tel.getText().toString());
