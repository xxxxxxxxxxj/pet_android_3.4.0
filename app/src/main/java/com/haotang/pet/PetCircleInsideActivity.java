...
public class PetCircleInsideActivity extends SuperActivity implements OnClickListener{
	...
	private SelectableRoundedImageView imageview_area_leader;
	private SelectableRoundedImageView imageview_shop_leader;
...
//		});
				...
				if (code==0) {
					...
					if (objectData.has("groupJl")&&!objectData.isNull("groupJl")) {
						...
						if (objectJL.has("headImg")&&!objectJL.isNull("headImg")) {
							...
							ImageLoaderUtil.loadImg(headImg,imageview_area_leader,  R.drawable.icon_self,null);
						}
					...
					if (objectData.has("groupDz")&&!objectData.isNull("groupDz")) {
						...
						if (objectDz.has("headImg")&&!objectDz.isNull("headImg")) {
							...
							ImageLoaderUtil.loadImg(headImg,imageview_shop_leader,  R.drawable.icon_self,null);
						}
	...
	private void initView() {
		...
		imageview_area_leader = (SelectableRoundedImageView) header.findViewById(R.id.imageview_area_leader);
		imageview_shop_leader = (SelectableRoundedImageView) header.findViewById(R.id.imageview_shop_leader);
