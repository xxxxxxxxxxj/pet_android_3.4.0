...
public class Global {
	...
	public static final int SERVICE_NEW_TO_ADD_PET_REQUESTCODE = 7505;
	...
	public static final int SERVICE_NEW_TO_UNLOGINTOSHOP=7508;
	public static final int SERVICE_NEW_TO_CHOOSEADDRESS=7509;
	public static final int CARDSDETAIL_NEW_TO_BUT_CARD=7610;
	public static final int ORDERDDETAIL_NEW_TO_CHOOSE_REMARK=7611;
	public static final int ORDERDDETAIL_NEW_TO_CHOOSE_COUPON=7612;
	public static final int BATHBEAY_NEW_TO_ORDERPAY=7613;
	public static final int BATHBEAUTY_NEW_TO_ORDERDETAILNEW=7614;
	public static final int APPOINTMENTNEW_TO_CHANGESERVICE=7615;
	public static final int MAIN_TO_LOGIN=7616;
	public static final int APPOINTNEW_TO_PAYCARD_SUCCESSED=7617;
	public static final int APPOINTNEW_TO_BEAUDETAI=7618;
	public static final int APPOINTNEW_DELETE_EXTRAITEM = 7619;
	public static final int ADACTIVITY_WXPAY_SUCCESS = 7620;
...
//		public static final String click_TrainingDog_ToRecharge = "click_TrainingDog_ToRecharge";//训犬游泳充值活动入口;//0
		...
		public static final String click_BeauticianCorner = "click_BeauticianCorner";//美容师等级问号;//1
		public static final String click_IndividualCorner = "click_IndividualCorner";//单项解释问号;//1
		public static final String click_RecommendPurchase = "click_RecommendPurchase";//选择美容师页购买服务卡入口;//1
		public static final String click_Purchase="click_Purchase";//购买服务卡入口
	}
