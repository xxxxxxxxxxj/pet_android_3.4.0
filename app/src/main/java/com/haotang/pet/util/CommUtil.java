...
//		return "http://m.cwjia.cn/";// 新的域名
	...
	public static void loginAuto(Context context, String phone, String imei,
		...
		String url = getServiceBaseUrl() + "pet/user/autoLogin?system="
	...
	public static void getH5Url(Context context,
			AsyncHttpResponseHandler handler) {
		String url = getServiceBaseUrl() + "pet/user/getInviteConfig?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
	...
	public static void getCompanyContact(Context context, long time,
		...
		String url = getServiceBaseUrl()
				+ "pet/user/getFeedbackPhoneInfo?system=" + getSource() + "_"
	...
	public static void getReadyReserve(Context context,
			AsyncHttpResponseHandler handler) {
		String url = getServiceBaseUrl() + "pet/hotel/ReadyReserve?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			AsyncHttpClient client = new AsyncHttpClient();
	...
	public static void getCitys(Context context,
			AsyncHttpResponseHandler handler) {
		String url = getServiceBaseUrl() + "pet/user/querycitylist?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			AsyncHttpClient client = new AsyncHttpClient();
	...
	public static void getGiftConfig(Context context,
			AsyncHttpResponseHandler handler) {
		String url = getServiceBaseUrl() + "pet/coupon/couponConfig?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			AsyncHttpClient client = new AsyncHttpClient();
	...
	public static void getHomeIndex(Context context,
			AsyncHttpResponseHandler handler) {
		String url = getServiceBaseUrl()
				+ "static/content/index/index.html?system=" + getSource() + "_"
				+ Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			AsyncHttpClient client = new AsyncHttpClient();
	...
	public static void getHomeData(Context context, int areaid, long time,
			AsyncHttpResponseHandler handler) {
		String url = getServiceBaseUrl() + "pet/user/homePage?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
	...
	public static void reserveCalendar(Context context,
			AsyncHttpResponseHandler handler) {
		String url = getServiceBaseUrl() + "pet/hotel/ReserveCalendar?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			AsyncHttpClient client = new AsyncHttpClient();
	...
	public static void getMatters(Context context,
			AsyncHttpResponseHandler handler) {
		String url = getServiceBaseUrl() + "pet/hotel/FosterageNotice?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			AsyncHttpClient client = new AsyncHttpClient();
	...
	public static void getCarePickUpRemindTxt(Context context,
			AsyncHttpResponseHandler handler) {
		String url = getServiceBaseUrl()
				+ "pet/order/orderCarePickUpRemindTxt?system=" + getSource()
				+ "_" + Global.getCurrentVersion(context);
		try {
			AsyncHttpClient client = new AsyncHttpClient();
			client.setTimeout(getTimeOut());
	...
	public static void getAvailableCoupon(Context context, String phone,
		...
		String url = getServiceBaseUrl() + "pet/coupon/mycoupons?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
	...
	public static void getServiceInArea(Context context, int areaid,
		...
		String url = getServiceBaseUrl() + "pet/order/queryServiceArea?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			if (lat > 0)
	...
	public static void queryTradeAreaByLoc(Context context, double lat,
		...
		String url = getServiceBaseUrl()
				+ "pet/shop/queryTradeAreaByLocNew?system=" + getSource() + "_"
				+ Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			if (lat > 0)
	...
	public static void getAccountBalance(Context context, String phone,
		...
		String url = getServiceBaseUrl()
				+ "pet/user/getUserAccountBalance?system=" + getSource() + "_"
				+ Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			AsyncHttpClient client = new AsyncHttpClient();
	...
	public static void prepareConfirmOrder(Context context, int roomType,
			...
			AsyncHttpResponseHandler handler) {
		String url = getServiceBaseUrl()
				+ "pet/hotel/prepareConfirmOrder?system=" + getSource() + "_"
				+ Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
	...
	public static void getShopRoom(Context context, int areaId, int petid,
			String starttime, String endtime, double lat, double lng,
			AsyncHttpResponseHandler handler) {
		String url = getServiceBaseUrl() + "pet/hotel/queryShopRoom?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			params.put("petId", petid);
	...
	public static void getPetServicedetail(Context context, int serviceid,
		...
		String url = getServiceBaseUrl() + "pet/owner/petservicedetail?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
	...
	public static void getPetServicedetailV2(Context context, int servicetype,
			...
			double lat, double lng, AsyncHttpResponseHandler handler) {
		String url = getServiceBaseUrl()
				+ "pet/owner/queryAppointDetail?system=" + getSource() + "_"
				+ Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			if (servicetype > 0)
	...
	public static void getPetServicedetailV3(Context context, int shopid,
		...
		String url = getServiceBaseUrl()
				+ "pet/owner/queryAppointDetails?system=" + getSource() + "_"
				+ Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			params.put("appTime", time);
	...
	public static void getPetServiceByAddPet(Context context, int petid,
			...
			AsyncHttpResponseHandler handler) {
		String url = getServiceBaseUrl() + "pet/owner/addPet?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			params.put("petId", petid);
	...
	public static void getPetService(Context context, int petid,
			AsyncHttpResponseHandler handler) {
		String url = getServiceBaseUrl() + "pet/owner/petservice?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			params.put("petId", petid);
	...
	public static void getBeauticianFreeTime(Context context, double lat,
		...
		String url = getServiceBaseUrl()
				+ "pet/worker/getTaskCalender1?system=" + getSource() + "_"
				+ Global.getCurrentVersion(context);
		try {
			AsyncHttpClient client = new AsyncHttpClient();
			RequestParams params = LocalParm(context);
	...
	public static void getBeauticianTimeById(Context context, double lat,
			...
			AsyncHttpResponseHandler handler) {
		String url = getServiceBaseUrl()
				+ "pet/worker/getTaskCalenderOfWorker?system=" + getSource()
				+ "_" + Global.getCurrentVersion(context);
		try {
			AsyncHttpClient client = new AsyncHttpClient();
			RequestParams params = LocalParm(context);
	...
	public static void getBeauticianList(Context context, String phone,
		...
		String url = getServiceBaseUrl()
				+ "pet/worker/getAvailableWorkers1?system=" + getSource() + "_"
				+ Global.getCurrentVersion(context);
		try {
			AsyncHttpClient client = new AsyncHttpClient();
			RequestParams params = LocalParm(context);
	...
	public static void getBeauticianListNoTimeLimit(Context context,
			...
			AsyncHttpResponseHandler handler) {
		String url = getServiceBaseUrl()
				+ "pet/worker/worker/getWorkersNoTimeLimit?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
		try {
			AsyncHttpClient client = new AsyncHttpClient();
			RequestParams params = LocalParm(context);
	...
	public static void newOrder(Context context, String phone, String imei,
			...
			AsyncHttpResponseHandler handler) {
		String url = getServiceBaseUrl() + "pet/order/newOrderm?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			if (shopid > 0)
	...
	public static void newOrderFostercare(Context context, String promoterCode,
		...
		String url = getServiceBaseUrl() + "pet/order/newOrderV2?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
	...
	public static void getBeauticianDetail(Context context, int workerid,
		...
		String url = getServiceBaseUrl() + "pet/worker/queryWorkerById?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			params.put("workerId", workerid);
	...
	public static void getProductionByBeauticianId(Context context,
			...
			AsyncHttpResponseHandler handler) {
		String url = getServiceBaseUrl()
				+ "pet/worker/queryWorksByWorkerId?system=" + getSource() + "_"
				+ Global.getCurrentVersion(context);
	...
	public static void getCommentByBeauticianId(Context context, int workerid,
		...
		String url = getServiceBaseUrl()
				+ "pet/worker/queryCommentsByWorkerId?system=" + getSource()
				+ "_" + Global.getCurrentVersion(context);
	...
	public static void getShopById(Context context, int shopid,
			AsyncHttpResponseHandler handler) {
		String url = getServiceBaseUrl() + "pet/worker/queryShopById?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
	...
	public static void feedBack(Context context, int userId, String phone,
			...
			AsyncHttpResponseHandler handler) {
		String url = getServiceBaseUrl() + "pet/user/feedback?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
	...
	public static void registGeTuitoService(Context context, String phone,
			...
			double lat, double lng, AsyncHttpResponseHandler handler) {
		String url = getServiceBaseUrl() + "pet/user/registUserDevice?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
	...
	public static void getIndex(Context context, String phone, String version,
		...
		String url = getServiceBaseUrl() + "pet/user/index?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			AsyncHttpClient client = new AsyncHttpClient();
	...
	public static void newCustomerPet(Context context, String phone,
			...
			AsyncHttpResponseHandler handler) {
		String url = getServiceBaseUrl() + "pet/user/newCustomerPet?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			params.put("petId", petid);
	...
	public static void deleteCustomerPet(Context context, String phone,
			...
			AsyncHttpResponseHandler handler) {
		String url = getWebBaseUrl() + "web/petcerti/api/deluserpet?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			if (id > 0)
	...
	public static void queryCustomerPetById(Context context, String phone,
			...
			AsyncHttpResponseHandler handler) {
		String url = getServiceBaseUrl()
				+ "pet/user/queryCustomerPetById?system=" + getSource() + "_"
				+ Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			if (id > 0)
	...
	public static void queryCustomerPets(Context context, String phone,
		...
		String url = getServiceBaseUrl() + "pet/user/queryCustomerPets?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			AsyncHttpClient client = new AsyncHttpClient();
	...
	public static void getWxMD5(Context context, String phone, String version,
			...
			AsyncHttpResponseHandler handler) {
		String url = getServiceBaseUrl() + "pet/tenpay/md5?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
	...
	public static void getListVersion(Context context,
			AsyncHttpResponseHandler handler) {
		String url = getServiceBaseUrl()
				+ "pet/owner/queryPetListVersion?system=" + getSource() + "_"
				+ Global.getCurrentVersion(context);
	...
	public static void confirmOrderStatus(Context context, String phone,
			...
			AsyncHttpResponseHandler handler) {
		String url = getServiceBaseUrl() + "pet/pay/confirmOrderStatus?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
	...
	public static void loginAu(Context context, String phone, String imei,
			...
			AsyncHttpResponseHandler handler) {
		String url = getServiceBaseUrl() + "pet/user/login?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
	...
	public static void genVerifyCode(Context context, String phone,
			AsyncHttpResponseHandler handler) {
		String url = getServiceBaseUrl() + "pet/user/genVerifyCode?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
	...
	public static void getPetList(Context context, int kind, int serviceId,
			...
			AsyncHttpResponseHandler handler) {
		String url = getServiceBaseUrl() + "pet/owner/petlist?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			if (kind > 0)
	...
	public static void addServiceAddress(String phone, int userId, String imei,
			...
			AsyncHttpResponseHandler handler) {
		String url = getServiceBaseUrl() + "pet/user/addServiceAddress?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
	...
	public static void queryServiceAddress(String phone, int userId,
		...
		String url = getServiceBaseUrl()
				+ "pet/user/queryServiceAddress?system=" + getSource() + "_"
				+ Global.getCurrentVersion(context);
	...
	public static void deleteServiceAddress(String phone, String imei,
		...
		String url = getServiceBaseUrl()
				+ "pet/user/deleteServiceAddress?system=" + getSource() + "_"
				+ Global.getCurrentVersion(context);
	...
	public static void queryMyOrders(String phone, String imei,
		...
		String url = getServiceBaseUrl() + "pet/order/allOrders?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
	...
	public static void queryCanceledOrders(String phone, String imei,
			Context context, int page, AsyncHttpResponseHandler handler) {
		String url = getServiceBaseUrl() + "pet/order/canceledOrders?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
	...
	public static void queryProcessMyOrders(String phone, String imei,
			Context context, int page, AsyncHttpResponseHandler handler) {
		String url = getServiceBaseUrl() + "pet/order/ingOrders?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
	...
	public static void queryEvaluateMyOrders(String phone, String imei,
			Context context, int page, AsyncHttpResponseHandler handler) {
		String url = getServiceBaseUrl() + "pet/order/toCommentOrders?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			params.put("page", page);
	...
	public static void updateUser(String phone, String imei, Context context,
			...
			AsyncHttpResponseHandler handler) {
		String url = getServiceBaseUrl() + "pet/user/updateUser?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
	...
	public static void queryUserCoupons(String phone, String imei,
			Context context, int page, AsyncHttpResponseHandler handler) {
		String url = getServiceBaseUrl() + "pet/coupon/myacoupons?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			params.put("page", page);
	...
	public static void commentOrder(String phone, String imei, Context context,
			...
			AsyncHttpResponseHandler handler) {
		String url = getServiceBaseUrl() + "pet/order/commentOrder?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			params.put("id", id);
	...
	public static void queryOrderDetails(String phone, String imei,
		...
		String url = getServiceBaseUrl() + "pet/order/queryOrderDetail?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			params.put("id", id);
	...
	public static void queryRoomMenuItems(String phone, String imei,
			...
			AsyncHttpResponseHandler handler) {
		String url = getServiceBaseUrl()
				+ "pet/worker/queryRoomMenuItems?system=" + getSource() + "_"
				+ Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			params.put("roomType", roomType);
	...
	public static void cancelOrder(String phone, String imei, Context context,
		...
		String url = getServiceBaseUrl() + "pet/order/cancelOrder?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			params.put("id", id);
	...
	public static void orderSwimCancelRemindTxt(String phone, String imei,
			...
			AsyncHttpResponseHandler handler) {
		String url = getServiceBaseUrl()
				+ "pet/order/orderSwimCancelRemindTxt?system=" + getSource()
				+ "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			params.put("id", id);
	...
	public static void confirmOrder(String phone, String imei, Context context,
			int id, AsyncHttpResponseHandler handler) {
		String url = getServiceBaseUrl() + "pet/order/confirmOrder?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			params.put("id", id);
	...
	public static void changeOrderPayMethod(String phone, String imei,
		...
		String url = getServiceBaseUrl()
				+ "pet/order/changeOrderPayMethod?system=" + getSource() + "_"
				+ Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
	...
	public static void changeOrderPayMethodV2(String promoterCode,
		...
		String url = "";
		if (isVie) {
			url = getServiceBaseUrl() + "pet/vie/changePayWay?system="
					+ getSource() + "_" + Global.getCurrentVersion(context);
		} else {
			url = getServiceBaseUrl()
					+ "pet/order/changeOrderPayMethodV2?system=" + getSource()
					+ "_" + Global.getCurrentVersion(context);
		}
		try {
			RequestParams params = LocalParm(context);
	...
	public static void updateUserPushNotify(String imei, Context context,
		...
		String url = getServiceBaseUrl()
				+ "pet/user/updateUserPushNotify?system=" + getSource() + "_"
				+ Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
	...
	public static void redeemCouponCode(String phone, String imei,
		...
		String url = getServiceBaseUrl()
				+ "pet/coupon/redeemCouponCode?system=" + getSource() + "_"
				+ Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			params.put("code", code);
	...
	public static void getFe(Context context, AsyncHttpResponseHandler handler) {
		String url = CommUtil.getServiceBaseUrl()
				+ "pet/owner/getFeaturedService?system=" + getSource() + "_"
				+ Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			AsyncHttpClient client = new AsyncHttpClient();
	...
	public static void getShare(Context context, long time,
			AsyncHttpResponseHandler handler) {
		String url = CommUtil.getServiceBaseUrl()
				+ "static/content/share_text.html?time=" + time + "&system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			AsyncHttpClient client = new AsyncHttpClient();
	...
	public static void getRechargeTemplate(String imei, Context context,
			AsyncHttpResponseHandler handler) {
		String url = getServiceBaseUrl()
				+ "pet/user/getRechargeTemplate?system=" + getSource() + "_"
				+ Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			AsyncHttpClient client = new AsyncHttpClient();
	...
	public static void queryTradeHistory(String phone, String imei,
		...
		String url = getServiceBaseUrl() + "pet/user/queryTradeHistory?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
	...
	public static void recharge(String phone, String imei, Context context,
			...
			AsyncHttpResponseHandler handler) {
		String url = getServiceBaseUrl() + "pet/user/recharge?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			params.put("templateId", templateId);
	...
	public static void queryWorksByService(Context context, long servieId,
		...
		String url = getServiceBaseUrl()
				+ "pet/user/queryWorksByService?system=" + getSource() + "_"
				+ Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
	...
	public static void queryCommentsByService(Context context, String servieId,
		...
		String url = getServiceBaseUrl()
				+ "pet/user/queryCommentsByService?system=" + getSource() + "_"
				+ Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			params.put("before", before);
	...
	public static void GetShopInfo(Context context, int shopId, int serviceId,
			AsyncHttpResponseHandler handler) {
		String url = getServiceBaseUrl() + "pet/order/GetShopInfo?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			params.put("shopId", shopId);
	...
	public static void getHomeDetail(Context context, int shopId, String time,
		...
		String url = getServiceBaseUrl() + "static/content/homesvc/" + shopId
				+ "/desc?time=" + time + "&system=" + getSource() + "_"
				+ Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			AsyncHttpClient client = new AsyncHttpClient();
	...
	public static void myacouponsunused(String phone, String imei,
			Context context, int page, AsyncHttpResponseHandler handler) {
		String url = getServiceBaseUrl()
				+ "pet/coupon/myacouponsunused?system=" + getSource() + "_"
				+ Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			params.put("page", page);
	...
	public static void myacouponsused(String phone, String imei,
			Context context, int page, AsyncHttpResponseHandler handler) {
		String url = getServiceBaseUrl() + "pet/coupon/myacouponsused?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			params.put("page", page);
	...
	public static void queryShopsWithPrice(Context context, String strp,
		...
		String url = getServiceBaseUrl()
				+ "pet/owner/queryShopsWithPrice?system=" + getSource() + "_"
				+ Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			params.put("strp", strp);
	...
	public static void searchTradeArea(Context context, double lat, double lng,
			AsyncHttpResponseHandler handler) {
		String url = getServiceBaseUrl() + "pet/hotel/searchTradeArea?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			params.put("lat", lat);
	...
	public static void prepCancelOrder(String phone, String imei,
			Context context, int id, AsyncHttpResponseHandler handler) {
		String url = getServiceBaseUrl() + "pet/hotel/prepCancelOrder?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			params.put("id", id);
	...
	public static void orderCareCancelRemindTxt(String phone, String imei,
			...
			AsyncHttpResponseHandler handler) {
		String url = getServiceBaseUrl()
				+ "pet/order/orderCareCancelRemindTxt?system=" + getSource()
				+ "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			params.put("id", id);
	...
	public static void getAddPetTipAfterOrder(Context context,
			AsyncHttpResponseHandler handler) {
		String url = getServiceBaseUrl()
				+ "pet/order/getAddPetTipAfterOrder?system=" + getSource()
				+ "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			AsyncHttpClient client = new AsyncHttpClient();
	...
	public static void getTipTxtAfterComment(Context context, int id,
			AsyncHttpResponseHandler handler) {
		String url = getServiceBaseUrl()
				+ "pet/order/getTipTxtAfterComment?id=" + id + "&system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			AsyncHttpClient client = new AsyncHttpClient();
	...
	public static void getHospital_List(Context context,
			AsyncHttpResponseHandler handler) {
		String url = getServiceBaseUrl()
				+ "static/content/index/hospital_list.html?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			AsyncHttpClient client = new AsyncHttpClient();
	...
	public static void getEntertain_List(Context context,
			AsyncHttpResponseHandler handler) {
		String url = getServiceBaseUrl()
				+ "static/content/index/entertain_list.html?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			AsyncHttpClient client = new AsyncHttpClient();
	...
	public static void getFeaturedService1(String phone, String imei,
			Context context, int petId, int typeId, int level, int workerId,
			int shopId, AsyncHttpResponseHandler handler) {
		String url = getServiceBaseUrl()
				+ "pet/owner/getFeaturedService1?system=" + getSource() + "_"
				+ Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			params.put("petId", petId);
	...
	public static void getWorkerByName(Context context, int areaid,
			...
			AsyncHttpResponseHandler handler) {
		String url = getServiceBaseUrl()
				+ "pet/worker/queryWorkersByName?system=" + getSource() + "_"
				+ Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			if (areaid > 0 && areaid != 100)
	...
	public static void getAllWorkers(String phone, String imei,
			...
			int shopId, AsyncHttpResponseHandler handler) {
		String url = getServiceBaseUrl() + "pet/worker/allWorkers?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
	...
	public static void queryWorkerMenuItems(Context context, int canWorkAtHome,
		...
		String url = getServiceBaseUrl()
				...
				+ "&workerId=" + workerid + "&system=" + getSource() + "_"
				+ Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			AsyncHttpClient client = new AsyncHttpClient();
	...
	public static void getServiceArea(Context context,
		...
		String url = getServiceBaseUrl()
				+ "pet/shop/queryTradeAreaWithShop?system=" + getSource() + "_"
				+ Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			AsyncHttpClient client = new AsyncHttpClient();
	...
	public static void getServiceAreaInfo(Context context,
		...
		String url = getServiceBaseUrl() + "pet/shop/queryTradeAreaByLoc?lat="
				+ lat + "&lng=" + lng + "&system=" + getSource() + "_"
				+ Global.getCurrentVersion(context);
		try {
			AsyncHttpClient client = new AsyncHttpClient();
			client.setTimeout(getTimeOut());
	...
	public static void getInsertReminderlog(String phone, String imei,
		...
		String url = getServiceBaseUrl()
				+ "pet/order/insertReminderlog?system=" + getSource() + "_"
				+ Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
	...
	public static void getLoadAppointments(Context context,
			AsyncHttpResponseHandler handler) {
		String url = getServiceBaseUrl() + "pet/vie/loadAppointments?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
		try {
			AsyncHttpClient client = new AsyncHttpClient();
			client.setTimeout(getTimeOut());
	...
	public static void saveOrder(Context context, String cellPhone, int userId,
			...
			String telephone, String remark, String cardIds,
			AsyncHttpResponseHandler handler) {
		String url = getServiceBaseUrl() + "pet/vie/saveOrder?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			params.put("userId", userId);
	...
	public static void getSwimTime(Context context, String phone, int shopId,
			AsyncHttpResponseHandler handler) {
		String url = getServiceBaseUrl() + "pet/order/getSwimTime?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			params.put("shopId", shopId);
	...
	public static void getSwimTimeNew(Context context, String phone,
			int shopId, AsyncHttpResponseHandler handler) {
		String url = getServiceBaseUrl() + "pet/order/getSwimTimeNew?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			params.put("shopId", shopId);
	...
	public static void getSwimDetail(Context context, String phone, int shopId,
		...
		String url = getServiceBaseUrl() + "pet/order/getSwimDetail?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			params.put("shopId", shopId);
	...
	public static void getSwimOrder(Context context, String phone, int shopid,
		...
		String url = getServiceBaseUrl() + "pet/order/swimOrder?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			if (shopid > 0)
	...
	public static void getResidualTimeOfPay(Context context, String phone,
		...
		String url = getServiceBaseUrl()
				+ "pet/order/getResidualTimeOfPay?system=" + getSource() + "_"
				+ Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			params.put("customerId", customerId);
	...
	public static void canBePickup(Context context, String phone, int areaId,
			...
			AsyncHttpResponseHandler handler) {
		String url = getServiceBaseUrl() + "pet/vie/canBePickup?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			if (areaId > 0) {
	...
	public static void getOrderInfo(Context context, String cellphone,
		...
		String url = getServiceBaseUrl()
				+ "pet/certiOrder/queryCertiOrderById?system=" + getSource()
				+ "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
	...
	public static void changePayWay(String promoterCode, boolean isHybirdPay,
		...
		String url = getServiceBaseUrl()
				+ "pet/certiOrder/changePayWay?system=" + getSource() + "_"
				+ Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
	...
	public static void loadExtraMenus(Context context, String cellphone,
		...
		String url = getServiceBaseUrl() + "pet/user/loadExtraMenus?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			AsyncHttpClient client = new AsyncHttpClient();
	...
	public static void mycouponsForSwim(Context context, String phone,
			...
			AsyncHttpResponseHandler handler) {
		String url = getServiceBaseUrl()
				+ "pet/coupon/mycouponsForSwim?system=" + getSource() + "_"
				+ Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			params.put("appointment", time);
	...
	public static void checkRedeemCode(String redeemCode, int couponId,
		...
		String url = getServiceBaseUrl()
				+ "pet/certiOrder/checkRedeemCode?system=" + getSource() + "_"
				+ Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
	...
	public static void queryMyHotAddress(String cellphone, String imei,
		...
		String url = getServiceBaseUrl() + "pet/user/queryMyHotAddress?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			AsyncHttpClient client = new AsyncHttpClient();
	...
	public static void ConverBaiduToGaoDe(Context context, String lng,
		...
		String url = "http://restapi.amap.com/v3/assistant/coordinate/convert?locations="
				...
				+ ","
				+ lat
				+ "+&coordsys=baidu&output=json&key=e26a65e8ab9015b4953f8042edffe386"
				+ "&system="
				+ getSource()
				+ "_"
				+ Global.getCurrentVersion(context);
	...
	public static void queryAvailableWorkers(Context context,
		...
		String url = getServiceBaseUrl()
				+ "pet/worker/queryAvailableWorkers?system=" + getSource()
				+ "_" + Global.getCurrentVersion(context);
		try {
			AsyncHttpClient client = new AsyncHttpClient();
			RequestParams params = LocalParm(context);
	...
	public static void saveCancelReason(String cellphone, String imei,
			Context context, int id, String reason,
			AsyncHttpResponseHandler handler) {
		String url = getServiceBaseUrl() + "pet/order/saveCancelReason?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			params.put("id", id);
			if(Utils.isStrNull(reason)){
				...
				Log.e("TAG", "reason.getBytes() = "+reason.getBytes());
				String str = new String(reason.getBytes(),"UTF-8");
				Log.e("TAG", "str = "+str);
	...
	public static void checkDhmCode(String cellphone, String serialNum,
		...
		String url = getServiceBaseUrl() + "pet/pay/checkRechargeCard?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
	...
	public static void rechargeWithCard(String cellphone, String serialNum,
		...
		String url = getServiceBaseUrl() + "pet/pay/rechargeWithCard?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			params.put("serialNum", serialNum);
	...
	public static void queryPostInfoList(String phone, String imei,
			...
			AsyncHttpResponseHandler handler) {
		String url = getServiceBaseUrl()
				+ "pet/postInfo/queryPostInfoList?system=" + getSource() + "_"
				+ Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
	...
	public static void newPost(String phone, Context context, int groupId,
			...
			AsyncHttpResponseHandler handler) {
		String url = getServiceBaseUrl() + "pet/postInfo/newPost?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			if (postType == 1) {
	...
	public static void queryPostInfo(String phone, Context context, int postId,
		...
		String url = getServiceBaseUrl() + "pet/postInfo/queryPostInfo?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
	...
	public static void queryGroups(String phone, Context context,
			AsyncHttpResponseHandler handler) {
		String url = getServiceBaseUrl() + "pet/postInfo/queryGroups?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			AsyncHttpClient client = new AsyncHttpClient();
	...
	public static void followGroup(String phone, Context context, int groupId,
			AsyncHttpResponseHandler handler) {
		String url = getServiceBaseUrl() + "pet/postInfo/followGroup?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			params.put("groupId", groupId);
	...
	public static void queryGoodPosts(long timestamp, String phone,
		...
		String url = getServiceBaseUrl()
				+ "pet/postInfo/queryGoodPosts?system=" + getSource() + "_"
				+ Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			if (page < 1) {
	...
	public static void followUser(String phone, Context context, int userId,
		...
		String url = getServiceBaseUrl() + "pet/postInfo/followUser?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			params.put("userId", userId);
	...
	public static void giftPost(String phone, Context context, int postId,
		...
		String url = getServiceBaseUrl() + "pet/postInfo/giftPost?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			params.put("postId", postId);
	...
	public static void commentPost(int contentType, String phone,
		...
		String url = getServiceBaseUrl() + "pet/postInfo/commentPost?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			params.put("postId", postId);
	...
	public static void startPage(String cellphone, Context context,
		...
		String url = getServiceBaseUrl() + "pet/user/startPage?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			AsyncHttpClient client = new AsyncHttpClient();
	...
	public static void getUserData(String cellphone, Context context, int page,
		...
		String url = getServiceBaseUrl() + "pet/postInfo/getUserData?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			params.put("userId", userId);
	...
	public static void followList(String cellphone, Context context, int page,
		...
		String url = getServiceBaseUrl() + "pet/postInfo/followList?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			params.put("postId", postId);
	...
	public static void deletePost(String cellphone, Context context,
		...
		String url = getServiceBaseUrl() + "pet/postInfo/deletePost?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			params.put("postId", postId);
	...
	public static void giveCoupon(String cellphone, Context context,
		...
		String url = getServiceBaseUrl() + "pet/coupon/giveCoupon?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			params.put("couponId", couponId);
	...
	public static void confirmOrderPrompt(String cellphone, Context context,
		...
		String url = getServiceBaseUrl()
				+ "pet/order/confirmOrderPrompt?system=" + getSource() + "_"
				+ Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
	...
	public static void getUserFansOrfollow(String cellphone, Context context,
		...
		String url = getServiceBaseUrl()
				+ "pet/postInfo/getUserFansOrfollow?system=" + getSource()
				+ "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			params.put("type", type);
	...
	public static void checkRechargeInviteCode(String cellphone,
		...
		String url = getServiceBaseUrl()
				+ "pet/user/checkRechargeInviteCode?system=" + getSource()
				+ "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			params.put("inviteCode", inviteCode);
	...
	public static void loadMenuNames(Context context, String cellphone,
			AsyncHttpResponseHandler loadExtraMenusHanler) {
		String url = getServiceBaseUrl() + "pet/user/loadMenuNames?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			AsyncHttpClient client = new AsyncHttpClient();
	...
	public static void ScanCodePayment(String code, Context context,
		...
		String url = getServiceBaseUrl() + "pet/goods/prepay?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			params.put("code", code);
	...
	public static void ScanCodePay(String scanRemark, long scanOrderId,
		...
		String url = getServiceBaseUrl() + "pet/goods/pay?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
	...
	public static void Train(Context context, String cellphone, int areaId,
			int petId, AsyncHttpResponseHandler handler) {
		String url = getServiceBaseUrl() + "pet/train/items?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			if (areaId > 0 && areaId != 100) {
	...
	public static void getTrainVideos(Context context, String cellphone,
			AsyncHttpResponseHandler handler) {
		String url = getServiceBaseUrl() + "pet/train/getTrainVideos?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			AsyncHttpClient client = new AsyncHttpClient();
	...
	public static void trainPay(Context context, String cellphone,
		...
		String url = getServiceBaseUrl() + "pet/train/pay?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			params.put("appointment", appointment);
	...
	public static void getHomeActivityPage(Context context,
			AsyncHttpResponseHandler handler) {
		String url = getServiceBaseUrl()
				+ "/pet/user/getHomeActivityPage?system=" + getSource() + "_"
				+ Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			AsyncHttpClient client = new AsyncHttpClient();
	...
	public static void loadMemberInfo(Context context,
		...
		String url = getServiceBaseUrl() + "/pet/member/loadMemberInfo?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			AsyncHttpClient client = new AsyncHttpClient();
	...
	public static void queryWorkersByIds(Context context, String workerIds,
			AsyncHttpResponseHandler handler) {
		String url = getServiceBaseUrl()
				+ "pet/worker/queryWorkersByIds?system=" + getSource() + "_"
				+ Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
	...
	public static void modifyOrder(Context context, int workerId,
		...
		String url = getServiceBaseUrl() + "pet/order/modifyOrder?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			if (workerId > 0) {
	...
	public static void modifyOrderCheck(Context context, int workerId,
			...
			AsyncHttpResponseHandler handler) {
		String url = getServiceBaseUrl() + "pet/order/modifyOrderCheck?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			if (workerId > 0) {
	...
	public static void choose(Context context, AsyncHttpResponseHandler handler) {
		String url = getServiceBaseUrl() + "pet/feedback/choose?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			AsyncHttpClient client = new AsyncHttpClient();
	...
	public static void commentStar(Context context, int grade,
			AsyncHttpResponseHandler handler) {
		String url = getServiceBaseUrl() + "pet/order/commentStar?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
	...
	public static void reason(Context context, int feedType, int type,
		...
		String url = getServiceBaseUrl() + "pet/feedback/reason?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
	...
	public static void save(Context context, int feedType, String reason,
		...
		String url = getServiceBaseUrl() + "pet/feedback/save?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			params.put("feedType", feedType);
	...
	public static void history(Context context, int feedType,
		...
		String url = getServiceBaseUrl() + "pet/feedback/history?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			params.put("feedType", feedType);
	...
	public static void queryCustomerOrderComment(Context context, int page,
			AsyncHttpResponseHandler Handler) {
		String url = getServiceBaseUrl()
				+ "pet/user/queryCustomerOrderComment?system=" + getSource()
				+ "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			params.put("page", page);
	...
	public static void payWays(Context context, String type, int orderId,
		...
		String url = getServiceBaseUrl() + "pet/pay/payWays?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			params.put("type", type);
	...
	public static void detail(Context context, int orderId,
		...
		String url = getServiceBaseUrl() + "pet/feedback/detail?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			params.put("orderId", orderId);
	...
	public static void cardDetail(Context context, int id, int petId,
		...
		String url = getServiceBaseUrl() + "pet/card/cardDetail?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			params.put("id", id);
	...
	public static void myCardPackage(Context context, int page, int status,
			AsyncHttpResponseHandler cardDetail) {
		String url = getServiceBaseUrl() + "pet/card/myCardPackage?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			params.put("page", page);
	...
	/**
	 * pet/card/cardDetailForAppointment
	 * 
	 * @param context
	 * @param id
	 *            //次卡模版id
	 * @param strp
	 *            strp=562_1,583_2 //我的宠物id_服务id 用,隔开
	 * @param tid
	 *            //美容等级id
	 * @param handler
	 */
	public static void cardDetailForAppointment(Context context, int id,
			String strp, int tid, AsyncHttpResponseHandler handler) {
		String url = getServiceBaseUrl()
				+ "pet/card/cardDetailForAppointment?system=" + getSource()
				+ "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			params.put("id", id);
	 ...
	 *            1 //服务类型（1:洗澡、2:美容）
	 */
	public static void queryLastOrderInfo(Context context, int serviceType,
			AsyncHttpResponseHandler handler) {
		String url = getServiceBaseUrl()
				+ "pet/new/user/queryLastOrderInfo?system=" + getSource() + "_"
				+ Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			if (serviceType > 0) {
	...
	/**
	 * /new/service/queryServiceDetail
	 * 
	 * @param context
	 * @param serviceType
	 *            //服务类型（1:洗澡、2:美容、3:特色服务）
	 * @param myPetIds
	 *            "166,165", //已选宠物ID
	 * @param addressId
	 *            267, //地址ID
	 ...
	 * @param handler
	 */
	public static void queryServiceDetail(Context context, int serviceType,
			String myPetIds, int addressId, int workerId, int shopId,
			AsyncHttpResponseHandler handler) {
		String url = getServiceBaseUrl()
				+ "pet/new/service/queryServiceDetail?system=" + getSource()
				+ "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			if (serviceType > 0) {
	...
	public static void getNewHomeData(Context context,
			AsyncHttpResponseHandler handler) {
		String url = getServiceBaseUrl() + "pet/user/newHomePage?system="
				+ getSource() + "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			AsyncHttpClient client = new AsyncHttpClient();
	...
	public static void querySelectedWorkers(Context context,
			...
			String workerIds, int serviceType, int source,
			AsyncHttpResponseHandler querySelectedWorkersHandler) {
		String url = getServiceBaseUrl()
				+ "pet/new/worker/querySelectedWorkers?system=" + getSource()
				+ "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			...
			Utils.mLogError("加载可预约美容师信息："
					+ client.getUrlWithQueryString(true, url, params));
			client.post(url, params, querySelectedWorkersHandler);
		} catch (Exception ex) {
			ex.printStackTrace();
		}
	}

	public static void queryExtraItems(Context context, String strp,
			AsyncHttpResponseHandler queryExtraItemsHandler) {
		String url = getServiceBaseUrl()
				+ "pet/new/service/queryExtraItems?system=" + getSource() + "_"
				+ Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			params.put("strp", strp);
			...
			Utils.mLogError("加载单项："
					+ client.getUrlWithQueryString(true, url, params));
			client.post(url, params, queryExtraItemsHandler);
		} catch (Exception ex) {
			ex.printStackTrace();
		}
	}

	public static void queryAvailableCards(Context context, String strp,
			int level, AsyncHttpResponseHandler queryAvailableCardsHandler) {
		String url = getServiceBaseUrl()
				+ "pet/new/card/queryRecommendTimeCards?system=" + getSource()
				+ "_" + Global.getCurrentVersion(context);
		try {
			RequestParams params = LocalParm(context);
			params.put("strp", strp);
			...
			AsyncHttpClient client = new AsyncHttpClient();
			client.setTimeout(getTimeOut());
			Utils.mLogError("加载可购买的次卡列表："
					+ client.getUrlWithQueryString(true, url, params));
			client.post(url, params, queryAvailableCardsHandler);
		} catch (Exception ex) {
			ex.printStackTrace();
		}
	}
