...
public class MulPetAddServiceActivity extends SuperActivity implements
	...
	private void setView() {
		...
		fIntent = getIntent();
		appointMentNewPetInfo = (AppointMentNewPetInfo) fIntent
		...
		beautician_sort = appointMentNewPetInfo.getLevel();
