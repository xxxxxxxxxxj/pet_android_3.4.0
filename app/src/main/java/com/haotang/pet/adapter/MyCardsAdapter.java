...
public class MyCardsAdapter<T> extends CommonAdapter<T>{
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (!TextUtils.isEmpty(cards.discountImg)) {
			viewHolder.setBackgroundNormal(mContext,R.id.card_cir_icon, cards.discountImg, R.drawable.card_cutdown);
		}else {
...
//			my_cards_image_back.setLayoutParams(params);
			try {
				viewHolder.setBackgroundNormal(mContext,R.id.my_cards_image_back, cards.cardBgImg,0/* R.drawable.mycard_back*/);
			} catch (Exception e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
...
//			my_cards_image_back.setLayoutParams(params);
			try {
				viewHolder.setBackgroundNormal(mContext,R.id.my_cards_image_back,"",R.drawable.card_out_data);
			} catch (Exception e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
