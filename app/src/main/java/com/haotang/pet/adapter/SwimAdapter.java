...
//		if (swimIcon.outOrInside==2) {
		if (position==0) {
			viewHolder.setBackgroundNormal(mContext,R.id.imageView_item_swim_icon, swimIcon.picPath.replace(".png", "2.png"), R.drawable.wifi);
		}else if (position==1) {
			viewHolder.setBackgroundNormal(mContext,R.id.imageView_item_swim_icon, swimIcon.picPath.replace(".png", "2.png"), R.drawable.air_cool);
		}else if (position==2) {
			viewHolder.setBackgroundNormal(mContext,R.id.imageView_item_swim_icon, swimIcon.picPath.replace(".png", "2.png"), R.drawable.aired_cool);
		}else if (position==3) {
			viewHolder.setBackgroundNormal(mContext,R.id.imageView_item_swim_icon, swimIcon.picPath.replace(".png", "2.png"), R.drawable.park);
		}else if (position==4) {
			viewHolder.setBackgroundNormal(mContext,R.id.imageView_item_swim_icon, swimIcon.picPath.replace(".png", "2.png"), R.drawable.sleeping);
		}
//		}
