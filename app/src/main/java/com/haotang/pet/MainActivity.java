...
public class MainActivity extends BaseFragmentActivity implements
	...
	private void setImg(int i, String str) {
		...
		switch (i) {
		case 0:
			//GlideUtil.loadImg(MainActivity.this,str, ivTabMain, R.drawable.tab_main);
			GlideUtil.loadImg(MainActivity.this,str, iv_mainactivity_one,
					R.drawable.tab_home_passed);
			break;
		case 1:
			//GlideUtil.loadImg(MainActivity.this,str, ivTabMemb, R.drawable.tab_knowledge);
			GlideUtil.loadImg(MainActivity.this,str, iv_mainactivity_two,
					R.drawable.tab_knowledge_passed);
			break;
		case 2:
			//GlideUtil.loadImg(MainActivity.this,str, ivTabOrder, R.drawable.tab_order);
			GlideUtil.loadImg(MainActivity.this,str, iv_mainactivity_three,
					R.drawable.tab_order_passed);
			break;
		case 3:
			//GlideUtil.loadImg(MainActivity.this,str, ivTabMy, R.drawable.tab_my);
			GlideUtil.loadImg(MainActivity.this,str, iv_mainactivity_four,
					R.drawable.tab_my_passed);
			break;
		}
	}
