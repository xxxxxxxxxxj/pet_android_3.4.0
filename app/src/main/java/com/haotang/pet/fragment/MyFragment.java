...
public class MyFragment extends Fragment implements OnClickListener,
	...
	private LinearLayout ll_myfragment_scan;
	...
	private void initLinster() {
		ll_myfragment_scan.setOnClickListener(this);
	...
	private void intiView(View convertView) {
		ll_myfragment_scan = (LinearLayout) convertView
				.findViewById(R.id.ll_myfragment_scan);
	...
	private void showUserInfo(String username, String imagepath) {
		if (memberIcon != null && !TextUtils.isEmpty(memberIcon)) {
			GlideUtil.loadImg(mainActivity,memberIcon, iv_myfragment_level,
		...
		if (username != null && !"".equals(username.trim())) {
			...
			textView_login_user_name_by_self.setText("未填写昵称");
		}
		...
		GlideUtil.loadImg(mainActivity,imagepath, iv_myfragment_topbg,
				R.drawable.cus_petinfo_back);
	}
	...
	public void onResume() {
		...
		iv_myfragment_level.setVisibility(View.GONE);
		GlideUtil.loadImg(mainActivity,"drawable://" + R.drawable.cus_petinfo_back,
				iv_myfragment_topbg, R.drawable.cus_petinfo_back);
		GlideUtil.loadImg(mainActivity,"drawable://" + R.drawable.user_icon_unnet,
				imageView_myfragment_icon, R.drawable.user_icon_unnet);
	...
	public void onClick(View view) {
		switch (view.getId()) {
		case R.id.ll_myfragment_scan:// 扫一扫
			startActivity(new Intent(mainActivity, MipcaActivityCapture.class));
			UmengStatistics.UmengEventStatistics(mainActivity,
		...
		public void onSuccess(int statusCode, Header[] headers,
			...
			try {
				...
				if (0 == resultCode) {
					...
					tv_myfragment_czz.setText(String.valueOf(0));
					iv_myfragment_level.setVisibility(View.GONE);
					GlideUtil.loadImg(mainActivity,"drawable://"
